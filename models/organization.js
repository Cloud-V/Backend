...
organizationSchema.methods.authorize = function (
    username,
    authorizerLevel,
    level,
    cb
    ...
    const OrganizationAccessLevel =
        require("./organization_access").AccessLevel;
                ...
                return Organization.getOrganizationRoleEntry(
                    ...
                    function (err, role) {
                        if (err) {
                            ...
                            return Organization.assignRole(
                                orgId,
                                user._id,
                                level,
                                cb
                            ...
                            role.accessLevel === OrganizationAccessLevel.Owner
                        ) {
                            return cb({
                            ...
                            return Organization.updateUserRole(
                                orgId,
                                user._id,
                                level,
                                cb
...
organizationSchema.methods.deauthorize = function (
    username,
    authorizerLevel,
    cb
) {
