...
const createOrganization = function (organization, cb) {
    ...
    if (
        typeof organization.prefix !== "string" ||
        !organization.prefix.length
    ) {
    ...
    if (organization.teamTitleP == null || !organization.teamTitleP.length) {
        newOrganization.teamTitleP = pluralize.plural(
            newOrganization.teamTitle
        );
    }
    if (
        organization.projectTitle == null ||
        !organization.projectTitle.length
    ) {
        newOrganization.projectTitle = "Project";
    }
    if (
        organization.projectTitleP == null ||
        !organization.projectTitleP.length
    ) {
        newOrganization.projectTitleP = pluralize.plural(
            newOrganization.projectTitle
        );
    }
